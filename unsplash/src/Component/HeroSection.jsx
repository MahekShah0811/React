      ...
      <section className='flex items-end justify-between w-full '>
        ...
        <div className='w-1/2 border border-gray-200 rounded-lg px-4 py-6 flex items-center justify-evenly max-w-xl'>
            ...
            <div className='w-1/2 flex flex-col justify-end items-start gap-y-25'>
                ...
                <div>
                    ...
                    {/* svg icon */}
                        ...
                        <p className='text-[15px] font-semibold leading-normal py-2'>
                            Create confidently with<br />
                            enhanched legal protection.
                        </p>

                        <p className='text-[15px] font-semibold leading-normal py-2 text-[#767676]'>
                            Premium downloads<br />
            ...
            <div className='relative w-1/2'>
                <img src="https://unsplash-assets.imgix.net/modules/legal-protections/photo-1.jpg?w=192&dpr=1&h=257&auto=format&fit=crop&q=60" alt='img1'
                className='-rotate-6'/>

                <img src='https://unsplash-assets.imgix.net/modules/legal-protections/photo-2.jpg?w=192&dpr=1&h=257&auto=format&fit=crop&q=60' alt='img2'
