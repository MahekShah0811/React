  ...
  return (
   <div className="mb-6 break-inside-avoid perspective">
     <div className="relative w-full h-full duration-500 transform-style-preserve-3d hover:rotate-y-180">
       {/* FRONT */}
       <div className="rounded-2xl overflow-hidden shadow-lg backface-hidden"
       ...
       {/* BACK */}
       <div className="absolute top-0 left-0 w-full h-full rounded-2xl flex items-center justify-center text-center p-4 rotate-y-180 backface-hidden"
