...
const Hero = () => {
  return (
    <>
      <section className="max-lg:bg-[url(/girl.png)] bg-no-repeat bg-cover bg-center lg:bg-[#cebdb5] h-screen md:h-136  overflow-hidden flex items-center justify-between md:px-6 w-full">
        <div className="w-full lg:backdrop-blur-none backdrop-blur-sm h-screen flex items-start justify-center flex-col lg:w-1/2 px-6 lg:pl-10 text-white lg:text-black">
          ...
          {/* description */}
          <p className="text-lg md:text-xl mt-3 font-normal leading-normal text-black/60">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab vel nihil quaerat illum qui? Natus.
          </p>
